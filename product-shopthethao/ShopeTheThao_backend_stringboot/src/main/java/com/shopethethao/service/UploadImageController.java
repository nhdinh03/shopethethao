...
public class UploadImageController {
    ...
    public ResponseEntity<Resource> readImage(@PathVariable String id) throws IOException {
        String path = Paths.get(System.getProperty("user.dir"), "ShopeTheThao_backend_stringboot/src/main/resources/static/images/" + id)
                .toString();
    ...
    public ResponseEntity<?> uploadImageA(@RequestParam("file_to_upload") MultipartFile file) throws IOException {
        ...
        try {
            String path = Paths.get(System.getProperty("user.dir"), "ShopeTheThao_backend_stringboot/src/main/resources/static/").toString();
    ...
    public ResponseEntity<?> updateImage(@PathVariable String imageName, @RequestParam("file_to_upload") MultipartFile file) throws IOException {
        ...
        String path = Paths.get(System.getProperty("user.dir"), "ShopeTheThao_backend_stringboot/src/main/resources/static/images/" + imageName).toString();
    ...
    public ResponseEntity<?> deleteImage(@PathVariable String id) {
        String path = Paths.get(System.getProperty("user.dir"), "ShopeTheThao_backend_stringboot/src/main/resources/static/images/" + id).toString();
