...
import { FiArrowRight, FiStar, FiHeart, FiShoppingBag, FiFilter, FiGrid, FiList, FiChevronDown } from "react-icons/fi";
...
const categories = [
  { id: 1, name: "Áo thun", image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
  { id: 2, name: "Áo khoác", image: "https://images.unsplash.com/photo-1544022613-e87ca75a784a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
  { id: 3, name: "Quần jeans", image: "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" },
  { id: 4, name: "Giày", image: "https://images.unsplash.com/photo-1491553895911-0055eca6402d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60" }
];
  ...
  const banners = [
    {
      ...
      buttonText: "Mua ngay",
      image: "https://images.unsplash.com/photo-1536766820879-059fec98ec0a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
    },
    {
      title: "Giày Thể Thao Mới Nhất",
      subtitle: "Thiết kế đặc biệt cho hiệu suất vượt trội",
      buttonText: "Khám phá",
      image: "https://images.unsplash.com/photo-1579298245158-33e8f568f7d3?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80"
    },
    {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (mockProducts && mockProducts.length > 0) {
        ...
        setFeaturedProducts(featured.length > 0 ? featured : mockProducts.slice(0, 4));
        console.log("Featured products set:", featured.length > 0 ? featured : mockProducts.slice(0, 4));
      } else {
          ...
          <div className="products-toolbar">
            ...
            <div className="view-options">
              <span className="product-count">
                Hiển thị {displayedProducts ? displayedProducts.length : 0} sản phẩm
              </span>
      ...
      <section className="featured-products">
        <div className="container">
          ...
          >
            ...
            <p>Khám phá các sản phẩm thể thao được yêu thích nhất của chúng tôi</p>
          </motion.div>
      ...
      <section className="brands-section">
        <div className="container">
          ...
          >
            ...
            <p>Chúng tôi hợp tác với các thương hiệu thể thao hàng đầu thế giới</p>
          </motion.div>
